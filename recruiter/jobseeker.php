	...
	<nav class="navbar navbar-default" role="navigation">
		<div class="container">
			...
			<div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" style="height: 1px;">
				...
				<li><a href="jobseekers.php">All Jobseekers</a></li>
...
<div class="container">
	<div class="single">  
		<div class="box_1">
			...
			<div class="col-md-5">
				<img src="<?php echo "../".$result['img_path']; ?>"  alt="" class="img-responsive img-thumbnail" height="400" width="300" />
			</div>
				...
				<div class="jumbotron">
					<div class="table-responsive">
						<table class="table table-hover" id="recruiterInfo">
							...
							<tr>
								<th><h4>Resume:</h4></th>
								<td><a href="download.php?filename=<?php echo $result['resume_path'];  ?>" class="btn btn-danger">Download</a></td>
							</tr>
						</table>
					</div>
