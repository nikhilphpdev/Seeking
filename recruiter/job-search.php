	...
	<nav class="navbar navbar-default" role="navigation">
		<div class="container">
			...
			<div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" style="height: 1px;">
				...
				<li><a href="recruiters.php">All Recruiter</a></li>
				<li  class="active"><a href="job-search.php">Search Jobs</a></li>
	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2 ">
			...
			if(isset($_POST['search'])) {
				...
				$stmt=$db->prepare("select * from jobs where skill like  ? OR location =? OR experience =?");
				$stmt->execute(array($skill,$location,$experience));
							...
							<div class="tab_grid">
								<div class="jobs-item with-thumb">
									...
									<div class="jobs_right">
										<div class="date">Job id <span><?php echo $result['id']; ?></span></div>
										...
										<td><a class = "btn btn-info" href="apply-job.php?job_id=<?php echo $result['id']; ?>">Apply</a></td>
