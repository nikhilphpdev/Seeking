	...
	<div class="single">
		...
		<div class="recruit_box">
			<div class="col-md-3 recruit">
				<img src="<?php echo "../".$result['img_path'];?>" alt="Jobseeker image"  class="img-responsive" />
				<h4><?php echo $result['name']; ?></h4>
				<h4><a href="jobseeker.php?id=<?php echo $result['id']; ?>" class="btn btn-warning">View Profile</a></h4>
			</a>
		</div>
	</div>
