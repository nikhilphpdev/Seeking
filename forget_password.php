	...
	if(isset($_POST['password']))
	{
		...
		$access_code = rand(10000000,1000000000000000);
		$to = $email;
		$subject = 'Password Change Access Code';
		$message = "http://justjob.96.lt/set-new-password.php?access_code=$access_code";
		mail($to, $subject, $message);
		
		$stmt=$db->prepare("update users set access_code = ? where email= ?");
		$stmt->execute(array($access_code,$email));
	}
			...
			<div class="login-form-section">
				<div class="login-content">
					<form method="post">
						...
						<div class="login-btn">
							<input type="submit" name = "password" value="Send Password">
