...
<div class="jumbotron">
	<div class="alert alert-success">	
		...
		if(isset($_POST['register']))
		{
			...
			$id=$name=$username=$password=$email=$contact_no=$gender=$dob=$address=$salary_expected=$qualification=$skills=$interested_area='';
			...
			if(!empty($_POST['interested_area']))
			{

				if(is_array($_POST['interested_area'])){
					$interested_area = implode(",",$_POST['interested_area']);
				}
				else
				{
					$interested_area = $_POST['interested_area'];
				}
			}
			...
			elseif($_POST['email']=="")
			{
				...
				$stmt=$db->prepare("insert into `users`(`id`, `name`, `username`, `password`, `email`, `dob`, `contact_no`, `address`, `gender`, `qualification`, `skills`, `img_path`, `intererested_area`, `salary_expected`, `resume_path`) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
				$stmt->execute(array($id,$name,$username,$password,$email,$dob,$contact_no,$address,
					$gender,$qualification,$skills,$img_path,$interested_area,$salary_expected,$resume_path));
