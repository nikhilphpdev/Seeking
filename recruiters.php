...
else
{
		...
		<nav class="navbar navbar-default" role="navigation">
			<div class="container">
				...
				<div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" style="height: 1px;">
					...
					<li class="active"><a href="recruiters.php">All Recruiter</a></li>
	...
	<div class="container">
		<div class="single">
			...
			$stmt=$db->query("select * from recruiters");
			...
			<div class="recruit_box">
				<div class="col-md-3 recruit">
					<img src="<?php echo "recruiter/".$result['img_path'];?>" alt="Recruiter image" height="200" width="200" class="img-responsive" />
					<h4><?php echo $result['name']; ?></h4>
					<h4><a href="recruiter.php?id=<?php echo $result['id']; ?>" class="btn btn-warning">View Profile</a></h4>
				</a>
			</div>
		</div>
